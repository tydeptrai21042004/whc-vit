...
#
# V01: vtab-dtd / ViT-B/16 / BS32 — all 5 methods in one resumable session.
...
spec='dtd:3.*.*'; b=tfds.builder(spec,data_dir=os.environ['DATA_PATH']); b.download_and_prepare(); print('TFDS READY',b.info.full_name)
PYDATA
